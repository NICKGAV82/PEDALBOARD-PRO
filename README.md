...
## [VISIT MY LIVE PROJECT HERE!](https://nickgav82.github.io/PEDALBOARD-PRO/)

![mock up design](mock-up.jpg)
...
### Typography -
- The 'Oswald' font was used throughout the project with a fall back font of sans-serif.

### Colour Scheme -
- A very simple pallete of Black, White and Bright Pink have been used within the project. Opacity was used with the Bright Pink when needed to either brighten or dull down the colour.

![colour scheme chart](colour-scheme.jpg) 
...
#### Testimonials on large screen -
![testimonials on large screen](quotes-lg.jpg)
#### Testimonials on small screen - 
...
- [Balsamiq Wireframes](https://balsamiq.com) was used in the making of the wireframe mockups during the design phase.
...
Both the [W3C Markup Validator](https://validator.w3.org/) and [W3C CSS Validator](https://jigsaw.w3.org/css-validator/) were used to test each page of the project to ensure the correct syntax was used. Main errors that occurred were the use of the same 'id' more than once. All errors have since been rectified and corrected. All pages have since passed the validation test. 

### Initial HTML tests/errors - 
![Index page HTML test](Index-HTML-test.jpg) 

### Passed HTML Validation -
![Index page HTML test passed](index-html-pass.jpg)

### Initial CSS test/errors -
![CSS Test](css-test.jpg)

### Passed CSS Validation -
![CSS pass](css-pass.jpg)

## Google Devtools/Lighthouse
While testing accessibilty and performance using Devtools/Lighthouse, the common issue was the file size of the images and video that were used. The images and video and have since been compressed to enhance performance. 

### Index test -
![Index page lighthouse test](index-lighthouse.jpg)
### About test -
![About page lighthouse test](about-lighthouse.jpg)
### Form test -
![Form page lighthouse test](form-lighthouse.jpg)

## Deployment
This project was deployed on to GitHub Pages. To do this I did the following.

1. Log in to the [GitHub Repository](https://github.com/NICKGAV82/PEDALBOARD-PRO)
2. Go to 'Settings'.
3. From 'Settings' navigate to 'GitHub Pages'.
4. Find 'Source' and click the 'None' dropdown menu and select 'Main Branch'.
...
- Powersupply image via [Adobe Stock](http://stock.adobe.com).

## Acknowledgements
Special thanks to both my tutor Miguel Ortega Legorreta at City of Bristol College for his support and guidance and to my mentor Rory Sheridan for his advice and feedback. I also have to mention the Slack community for their help in retreiveing my code from more thasn one hole! Finally thankyou to Code Institue for creating a course that can enable a complete coding beginner to create this project all the while enjoying the process!  

[def]: ../assets/images/mock-up.jpg